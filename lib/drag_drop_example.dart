...
class _ExampleDragAndDropState extends State<ExampleDragAndDrop> with TickerProviderStateMixin{
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      ...
      title: Text(
        'Order Food',
        style: Theme.of(context).textTheme.headlineMedium?.copyWith(fontSize: 36, color: const Color(0xFFF64209), fontWeight: FontWeight.bold),
      ),
      backgroundColor: const Color(0xFFF7F7F7),
      elevation: 0,
    );
  ...
  Widget build(BuildContext context){
    ...
    return Transform.scale(
      ...
      child: Material(
        ...
        child: Padding(padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 24),
        child: Column(
    ...
    return FractionalTranslation(
      ...
      child: ClipRRect(
        ...
        child: SizedBox(
          height: 150,
          width: 150,
          child: Opacity(opacity: 0.85, child: Image(image: photoProvider, fit: BoxFit.cover,),),
        ),
      ),  
    );
  }
